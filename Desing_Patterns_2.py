...
class QAEngineer(Employe):
    ...
    def test_feature(self)->str:pass
    ...
    #    print('pj dev1:',pj.developers[0].name)
    #    print('pj dev2:',pj.developers[1].name)
    #    print("dan pr:",dan.projects[0].title)
       
    #    AssignManagement(dan,pj).unassign()
    #    print('\npj dev:1',pj.developers[0].name)
